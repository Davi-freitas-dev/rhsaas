...
DRF_THROTTLE_DEMO_LEASE_RESUME_RATE = env_runtime_str(
    "DRF_THROTTLE_DEMO_LEASE_RESUME_RATE",
    DEFAULT_DRF_THROTTLE_DEMO_LEASE_RESUME_RATE,
)
...
DRF_THROTTLE_DEMO_STATUS_RATE = env_runtime_str(
    "DRF_THROTTLE_DEMO_STATUS_RATE",
    DEFAULT_DRF_THROTTLE_DEMO_STATUS_RATE,
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "demo_lease_resume": DRF_THROTTLE_DEMO_LEASE_RESUME_RATE,
        "demo_exchange": DRF_THROTTLE_DEMO_EXCHANGE_RATE,
        "demo_status": DRF_THROTTLE_DEMO_STATUS_RATE,
    },
...
PASSWORD_RESET_GATEWAY_SCHEMA = env(
    "PASSWORD_RESET_GATEWAY_SCHEMA",
    default=DEMO_PUBLIC_ENTRY_SCHEMA,
).strip()
PASSWORD_RESET_MIN_RESPONSE_SECONDS = env.float(
    "PASSWORD_RESET_MIN_RESPONSE_SECONDS",
    default=0.5,
)
PASSWORD_RESET_RESPONSE_JITTER_SECONDS = env.float(
    "PASSWORD_RESET_RESPONSE_JITTER_SECONDS",
    default=0.15,
)
PASSWORD_RESET_MIN_RESPONSE_MAX_SECONDS = 2.0
PASSWORD_RESET_JITTER_MAX_SECONDS = 1.0
PASSWORD_RESET_E2E_ENABLED = env.bool("PASSWORD_RESET_E2E_ENABLED", default=False)
EMAIL_FILE_PATH = env("EMAIL_FILE_PATH", default=str(BASE_DIR / ".e2e-emails"))
